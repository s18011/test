...
for (let y =0; y < 10; y++) {
    for (let x = 0; x < 10; x++) {
        ...
        c.moveTo(center.x + A.x, center.y + A.y);
        c.lineTo(center.x + C.x, center.y + C.y);
        c.lineTo(center.x + B.x, center.y + B.y);
        c.lineTo(center.x + E.x, center.y + E.y);
        c.lineTo(center.x + D.x, center.y + D.y);
        c.closePath();
        c.stroke();
